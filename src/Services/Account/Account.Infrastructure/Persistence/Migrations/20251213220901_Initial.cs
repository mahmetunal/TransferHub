        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Iban_Value = table.Column<string>(type: "character varying(34)", maxLength: 34, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BalanceReservations_AccountId",
                table: "BalanceReservations",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_BalanceReservations_AccountId_CommittedAt_ReleasedAt",
                table: "BalanceReservations",
                columns: new[] { "AccountId", "CommittedAt", "ReleasedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_BalanceReservations_TransferId",
                table: "BalanceReservations",
                column: "TransferId",
                unique: true);
