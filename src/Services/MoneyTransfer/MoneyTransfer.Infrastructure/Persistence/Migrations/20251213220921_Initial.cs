        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceAccount_Value = table.Column<string>(type: "character varying(34)", maxLength: 34, nullable: false),
                    DestinationAccount_Value = table.Column<string>(type: "character varying(34)", maxLength: 34, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SourceAccount = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    DestinationAccount = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferSagaState_CreatedAt",
                table: "TransferSagaState",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_TransferSagaState_CurrentState",
                table: "TransferSagaState",
                column: "CurrentState");

            migrationBuilder.CreateIndex(
                name: "IX_TransferSagaState_TransferId",
                table: "TransferSagaState",
                column: "TransferId",
                unique: true);
        }
